...
class wad(var items: Array<ModelWeather>) :
    RecyclerView.Adapter<wad.ViewHolder>() {
    // 뷰 홀더 만들어서 반환, 뷰릐 레이아웃은 list_item_weather.xml
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): wad.ViewHolder {
        val itemView =
    ...
    // 전달받은 위치의 아이템 연결
    override fun onBindViewHolder(holder: wad.ViewHolder, position: Int) {
